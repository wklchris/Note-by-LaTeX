...
最后，宏包还给出了\latexline{\\titleline}命令，用来绘制填充整行、同时又嵌有其他对象的线。对象可以嵌入到左中右lcr三个位置。如果你只是想填充一行而不嵌入对象，使用\latexline{\\titlerule}及其带星号的命令形式。
\begin{latex}{}
% 嵌入对象的线
...
\titleformat{\subsubsection}[hang]
    {\bfseries\large}{$\blacktriangleright$}{0.5em}{}
\end{latex}
