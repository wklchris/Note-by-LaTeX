...
\item 重要更新：
  \begin{feai}
  \item \sout{\textbf{TikZ 相关的内容停止更新}。原因是现有的其他软件绘图功能强大，导出为 pdf 格式的矢量图后也易于调用；TikZ 相比之下学习成本过高。}\textcolor{red}{\textbf{笔者又决定重启TikZ章节}}。（v1.6.3）
  \item \textbf{重新添加了 TikZ 章节} —— 不过仍是之前弃笔时的版本，预计将于 v1.7 更新。
