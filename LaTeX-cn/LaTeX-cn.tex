...
v1.6.1 更新 --- 2017年8月9日；\dpar

\begin{feai}
\item 重要更新：
  \begin{feai}
  \item \textbf{Tikz 相关的内容停止更新}。原因是现有的其他软件绘图功能强大，导出为 pdf 格式的矢量图后也易于调用；Tikz 相比之下学习成本过高。
  \item \textbf{增加了加快\xelatex 调用字体速度的方式}。参考“中文支持与CJK字体”一节\texttt{fc-cache}相关内容。
  \end{feai}
\item 字体更换：思源宋体。
