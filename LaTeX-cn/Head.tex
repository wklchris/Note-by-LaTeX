...
% 绘图
\usepackage{tikz}
  \usetikzlibrary{calc,intersections,positioning,angles,quotes}
...
\NewTCBListing{codeshow}{ O{listing side text} O{0.4\linewidth} }{
  ...
  left=6mm,righthand width=#2,fontupper=\small,
  % listing style
