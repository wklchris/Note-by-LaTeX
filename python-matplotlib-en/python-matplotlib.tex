...
\begin{itemize}
\item \uline{Have experiences of learning a programming language.} Being identified as a learner is enough. You needn't to become an export and exports won't read this book for sure. The syntax of \Py\ is one of the easiest to understand among all the programming languages. 
\item \uline{Be capacable to understand some basical math concepts}, such as linear and quadratic functions, is enough. 
\end{itemize}
